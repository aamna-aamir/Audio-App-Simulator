...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	public boolean equals(Object other)
	{
		...
		return super.equals(others) && composer.equals(others.composer) && artist.equals(others.artist);
	}
	...
	{
		if (this.getTitle().charAt(0) > other.getTitle().charAt(0)) return 1;
		if (this.getTitle().charAt(0) < other.getTitle().charAt(0)) return -1;
		return 0;
	}
}
